...
CREATE TABLE agents (
    ...
    mobile varchar(15),
    email varchar(75) UNIQUE NOT NULL,
    clients varchar(100) NOT NULL, # Might need to consider alternative way of listing client
...
CREATE TABLE gameplans (
    ...
    content varbinary(100) NOT NULL, # Verify this would theoretically allocate enough space for binary data, we could also change to link to a file
