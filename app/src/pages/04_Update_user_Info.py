...
try:
    ...
    if users:
        ...
        with st.form("update_gm_form"):
            ...
            role = st.selectbox("Role", ["general manager", "coach", "player", 'data analyst', "system administrator", "admin"], index=["general manager", "coach", "player", 'data analyst', "system administrator", "admin"].index(user_data.get('role')))
